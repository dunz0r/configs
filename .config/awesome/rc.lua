...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "Scroll_Lock", function () awful.spawn("i3lock -i /home/gabriel/Pictures/for_the_glory_of_satan.png") end,
              {description = "lock screen", group = "launcher"}),
    awful.key({ modkey,           }, "p", function () awful.spawn("/home/gabriel/bin/passdmenu.py") end,
